...
module CommandLine # Begin submodule RemoveLFS.CommandLine
...
function run_removelfs_snapshots_command_line!!(
        ;
    ...
    @info(
        string(
            "Running RemoveLFS.CommandLine.",
            "run_removelfs_snapshots_command_line!!"
            )
        )
...
end # End submodule RemoveLFS.CommandLine
